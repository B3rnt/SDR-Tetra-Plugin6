...
namespace SDRSharp.Tetra
{
    ...
    public class ReceivedData
    {
        ...
        public ReceivedData()
        {
            Data = new int[(int)GlobalNames.End];
            Clear();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetValue(GlobalNames name, int value)
        {
    ...
    public enum SdsProtocolIdent
    {
        ...
        Location_information_protokol = 10,
        Net_Assist_2 = 11,
    ...
    public enum LocationTypeExtension
    {
        ...
        Basic_location_parameters,
        Add_modify_trigger,
        Remove_trigger,
        Report_trigger,
        Report_basic_location_parameters,
        Location_reporting_enable_disable,
        Location_reporting_temporary_control,
        Backlog,
        Reserved_13,
        Reserved_14,
        Reserved_15
    ...
    unsafe static class Global
    {
        ...
        public static int ParseParams(LogicChannel channelData, int offset, Rules[] rules, ReceivedData result)
        {
            ...
            for (int i = 0; i < rules.Length; i++)
            {
                ...
                {
                    if (!result.Contains(GlobalNames.OutOfBuffer)) result.SetValue(GlobalNames.OutOfBuffer, 1);
                    return offset;
                }
                ...
                switch (param.Type)
                {
                    case RulesType.Direct:
                        if (param.GlobalName != GlobalNames.Reserved) result.SetValue(param.GlobalName, value);
                        offset += param.Length;
                        continue;
